      ...
      <div className='student__content'>
        <div className='student__info'>
          ...
          <p className='student__about'>
            Я родилась и живу в Шатуре, закончила факультет экономики МГСУ. У
            меня есть муж и кот. Я люблю смотреть фильмы, а ещё кататься на
            велосипеде. Недавно начала кодить. После прохождения курса по
            веб-разработке планирую уйти в IT.
          </p>
          <ul className='student__contacts'>
            <li>
              <a
                href='https://vk.com/elfeeika'
                className='student__contact'
                target='_blank'
                rel='noreferrer'
              >
                ВКонтакте
